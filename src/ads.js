    ...
    <div>
       <div class="w-[100%] h-[505px] bg-gray-100 relative">
            <div class="h-100vh ">                      
                ...
                <div onClick={()=> setVal(val+5)} class="rounded-full p-5 px-6 right-36 top-14  bg-yellow-400 absolute text-blue-900 text-center font-mono">
                    <code class="text-xl font-bold">only</code> <br/> 
                    <code class="text-4xl font-extrabold">${val}</code>
                </div>
